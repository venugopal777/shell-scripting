...
yum install nodejs gcc-c++ -y &>>${LOG FILE}
StatCheck $?

id ${APP_USER} &>>${LOG FILE}
if [ $? -ne 0 ]; then
...
rm -rf /home/${APP_USER}/catalogue &>>${LOG FILE}
StatCheck $?

Print "Extract App Content"
cd /home/${APP_USER}/ &>>${LOG FILE} && unzip -o /tmp/catalogue.zip &>>${LOG FILE} && mv catalogue-main catalogue &>>${LOG FILE}
StatCheck $?
